...
<body style="padding: 7rem;">
    <header>
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark"> <!--Logo-->
          <a class="navbar-brand" id="el-logo" href="../../index.html" ><img src="../../img/logo-unah.png" width="120"></a>
    ...
    <main>
    <h3>SISTEMA DE ESTUDIOS DE POSTGRADOS</h3>
      ...
      <div style="background-color:rgb(255, 255, 255, .9);padding: 5px "> 
        ...
        <div class="row" style="margin: 20px;">
            ...
            <table border="0" class="col-12" style="border:none">
                ...
                <tr>
                        <td>1</td>
                        <td>Esto tambien lo traera el servidor</td> 
