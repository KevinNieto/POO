    ...
    <h3>Servicio al Estudiante </h3>
        <div class="container-fluid">
            <div class="row" style="margin-left:100px;">
                <div class="col-xl-3 col-lg-3 col-md-none col-sm-none" id="estilos-cuadros" ><a href="adicionar-post.html">Adicionara asignatura</a></div>
                <div class="col-xl-3 col-lg-3 col-md-none col-sm-none" id="estilos-cuadros"><a href="cancelar-post.html">Cancelar asignatura</a></div>
                <div class="col-xl-3 col-lg-3 col-md-none col-sm-none" id="estilos-cuadros"><a href="hoja-matricula.html">Hoja de matricila</a></div>
            </div>
